<%@ Page Title="" Language="C#" MasterPageFile="~/LibraryUser.master" AutoEventWireup="true" CodeFile="IssueBook.aspx.cs" Inherits="IssueBook" %>
...
<center>
<h1><u>User Book Issued</u></h1>
<asp:UpdatePanel ID="issuepnl" runat="server">
<ContentTemplate>
<table cellspacing="4">
<tr>
...
<td colspan="2" align="center">
    ...
    <asp:Button ID="Button1" runat="server" Text="Issue Book" Height="30px" 
